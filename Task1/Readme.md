...
Для начало предпологал, что будет строиться по принципу **cloud-first, on-prem-later**, но есть интернет ограничения в которые упирается фермы. Хотя у данного подхода есть плюсы: 
...
- при большом росте ферм в дальнейшем будет большая стоимость предоставляемых улуг.
