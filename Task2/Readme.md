...
### **Consequences**
**Основное решение**:
- Преимущества: Полная оффлайн-поддержка (локальная аналитика в Spark), высокая масштабируемость (неограниченные агенты); переиспользование Kafka ~40%.
- Риски: Высокие первоначальные расходы на edge (~20% бюджета); сложность развертывания (5-6 недель).
